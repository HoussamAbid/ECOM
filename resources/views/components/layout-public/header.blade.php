<header class="p-3 bg-blue-100 text-bg-dark">
    <div class="container">
            ...
            <div class="text-end">
                @auth
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <input type="submit" class="btn btn-outline-primary text-white" value="Logout">
                        <a href="http://127.0.0.1:8000/adminauth" class="btn btn-outline-primary text-white"> admin</a>
                    </form>
                @endauth
                @guest
